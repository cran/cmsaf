...
test_that("data is correct", {
  ...
  expected <- c(
    77.5, 80.5, 83.5, 72.5, 75.5, 78.5, 81.5, 84.5, 73.5, 76.5, 79.5, 82.5,
    85.5, 86.5, 89.5, 92.5, 95.5, 98.5, 87.5, 90.5, 93.5, 96.5, 99.5, 88.5,
    91.5, 94.5, 97.5, 100.5, 40, 43, 46, 49, 52, 41, 44, 47, 50, 53, 42, 45,
    48, 51, 54, 55, 58, 61
  )
  expect_equivalent(actual[1023:1068], expected)

  expected <- c(
    82, 71, 74, 77, 80, 83, 72, 75, 78, 81, 84, 23.5, 26.5, 29.5, 32.5, 35.5,
    24.5, 27.5, 30.5, 33.5, 36.5, 25.5, 28.5, 31.5, 34.5, 37.5, 38.5, 41.5,
    44.5, 47.5, 50.5, 39.5, 42.5, 45.5, 48.5, 51.5, 40.5, 43.5, 46.5, 49.5,
    52.5, 53.5, 56.5, 59.5, 62.5, 65.5, 54.5, 57.5, 60.5, 63.5, 66.5, 55.5,
    58.5, 61.5, 64.5, 67.5, 68.5, 71.5, 74.5, 77.5, 80.5, 69.5, 72.5, 75.5,
    78.5, 81.5, 70.5, 73.5, 76.5, 79.5, 82.5, 83.5, 86.5, 89.5, 92.5, 95.5,
    84.5, 87.5, 90.5, 93.5, 96.5, 85.5, 88.5, 91.5
  )

fldx_wrapper <- function(op, var, infile, outfile, nc34, overwrite, verbose){
  ...
  switch(op,
         cmsaf_info <- paste0("cmsaf::fldmax for variable ", file_data$variable$name),
         cmsaf_info <- paste0("cmsaf::fldmin for variable ", file_data$variable$name),
         cmsaf_info <- paste0("cmsaf::fldmean for variable ",file_data$variable$name),
         cmsaf_info <- paste0("cmsaf::wfldmean for variable ",file_data$variable$name)
  )

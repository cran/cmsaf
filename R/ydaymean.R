...
#'
#'The function determines multi-year daily mean values from data of a single CM
#'SAF NetCDF input file.
#'
...
#'ydaymean("SIS", "CMSAF_example_file.nc", "CMSAF_example_file_ydaymean.nc")
#'
#'unlink(c("CMSAF_example_file.nc", "CMSAF_example_file_ydaymean.nc"))
ydaymean <- function(var, infile, outfile, nc34 = 4, overwrite = FALSE, verbose = FALSE) {
  ...
  time_bnds <- get_time_bounds_doy(
    file_data$dimension_data$t, doy
  )

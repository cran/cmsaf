...
#'selperiod("SIS", "2001-01-01", "2002-01-01", "CMSAF_example_file.nc",
#'  "CMSAF_example_file_selperiod.nc")
#'
#'unlink(c("CMSAF_example_file.nc", "CMSAF_example_file_selperiod.nc"))
selperiod <- function(var, start, end, infile, outfile, nc34 = 4,

cmsaf.mulc <-
function(var,const=1,infile,outfile,nc34=3){
...
# extract time information
 ...
 # create netcdf
  ...
  if (nc34==4){
    ...
    cmsaf_info <- (paste("cmsaf::cmsaf.mulc variable ",var," multiplied with ",const,sep=""))
    ...
    # multiply each timestep with a constant number
      ...
      for (i in 1:length(time1)){
	      ...
	      cat("\r","multiply constant with timestep ",i," of ",length(time1),sep="")

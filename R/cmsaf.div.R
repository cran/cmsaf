...
# define standard names
   ...
   v_long_name = paste("Result of div-function: ",vari1,"/",vari2,sep="")
   v_units = "undefined"
...
# get file information of infile1
 ...
 # create netcdf
  ...
  cat("create netcdf", "\n")
    ...
    # get data of infile1 and infile2 and divide corresponding fields
	...
	cat("\r","divide fields ",i," of ",length(time),sep="")

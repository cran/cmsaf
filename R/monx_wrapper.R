monx_wrapper <- function(op, var, infile, outfile, nc34, overwrite, verbose) {
  ...
  switch(op,
         cmsaf_info <- paste0("cmsaf::monmax for variable ", file_data$variable$name),
         cmsaf_info <- paste0("cmsaf::monmin for variable ", file_data$variable$name),
         cmsaf_info <- paste0("cmsaf::monmean for variable ", file_data$variable$name),
         cmsaf_info <- paste0("cmsaf::monsum for variable ", file_data$variable$name),
         cmsaf_info <- paste0("cmsaf::monsd for variable ", file_data$variable$name),
  )

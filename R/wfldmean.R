...
#'The calculation is based on the 'weighted.mean' function of the 'raster'
#'package.
#'
...
#'wfldmean("SIS", "CMSAF_example_file.nc", "CMSAF_example_file_wfldmean.nc")
#'
#'unlink(c("CMSAF_example_file.nc", "CMSAF_example_file_wfldmean.nc"))

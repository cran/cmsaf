yseasx_wrapper <- function(op, var, infile, outfile, nc34, overwrite, verbose) {
  ...
  switch(op,
         cmsaf_info <- paste0("cmsaf::yseasmax for variable ", file_data$variable$name),
         cmsaf_info <- paste0("cmsaf::yseasmin for variable ", file_data$variable$name),
         cmsaf_info <- paste0("cmsaf::yseasmean for variable ", file_data$variable$name),
         cmsaf_info <- paste0("cmsaf::yseassd for variable ", file_data$variable$name)
  )

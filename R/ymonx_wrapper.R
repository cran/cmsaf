ymonx_wrapper <- function(op, var, infile, outfile, nc34, overwrite, verbose) {
  ...
  switch(op,
         cmsaf_info <- paste0("cmsaf::ymonmax for variable ", file_data$variable$name),
         cmsaf_info <- paste0("cmsaf::ymonmin for variable ", file_data$variable$name),
         cmsaf_info <- paste0("cmsaf::ymonmean for variable ", file_data$variable$name),
         cmsaf_info <- paste0("cmsaf::ymonsum for variable ", file_data$variable$name),
         cmsaf_info <- paste0("cmsaf::ymonsd for variable ", file_data$variable$name)
  )

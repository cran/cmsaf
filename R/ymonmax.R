...
# create netcdf
  ...
  if (nc34==4){
    ...
    cmsaf_info <- (paste("cmsaf::ymonmax for variable ",var,sep=""))
    ...
    # get data and calculate multi-year monthly maximum
